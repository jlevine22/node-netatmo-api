...
function NetatmoClient(options) {
	...
	if (typeof this.options.clientId == undefined || typeof this.options.clientSecret == undefined) {
			...
			switch (response.statusCode) {
				...
				case 403:
					...
					if (jsonBody.error.code == 3) {
						...
						return reject(new (errors.ForbiddenError)(jsonBody.error.message));
					}
					break;
				default:
 ...
 * @returns {Promise}
 */
function callbackOrPromise(callback, promise) {
